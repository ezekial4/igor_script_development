...
//	Make/D/N=4/O W_coef
//	W_coef[0] = {5e12,3e13,2000,10}
//	FuncFit/NTHR=0/TBOX=775 zeke_tanh W_coef  neped_cm[pcsr(A),pcsr(B)] /X=time_neped /W=neped_err_cm /I=1 /D 
	...
	String leg_str4 = num2str(W_fitConstants[0])
       ...
       AppendText/N=CF_neped_cm "\\JLModel = y0 + A*exp[-(x-x0)/\\F'Symbol't\\F'Century Gothic'\\Beff\\M]"
