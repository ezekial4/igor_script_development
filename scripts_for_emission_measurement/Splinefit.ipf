...
Function splinefit(y_data,x_data,y_error,knots,outpnts)
	...
	Interpolate2/T=2/J=2/N=(outpnts)/E=2/I=0/A=(knots)/Y=temp2/X=temp1 $x_data, $y_data
       Duplicate/O temp1 $x_data+"_CS"
	Duplicate/O temp2 $y_data+"_CS"
	...
	If (outpnts > pnts)
		...
		for (i= 0; i<(wavmax);i+=1)
			loc = dummy[i]
			FindValue/T=0.01/V=(loc) $x_data+"_CS"
	...
	KillWaves y_diff_sq,temp1,temp2
End
