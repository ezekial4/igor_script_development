...
//use:
//	NumberIterations=IR1R_MaximumEntropy(MeasuredData,MeasuredDataErrorrs,SkyBackground,MaxsasNumIter,ModelDistribution,MaxEntStabilityParam,Opus,Tropus,MaxEntUpdateDataForGrph)
